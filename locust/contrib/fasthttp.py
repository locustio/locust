...
class FastHttpSession(object):
    ...
    def __init__(
        self, environment: Environment, base_url: str, insecure=True, **kwargs
    ):
...
class LocustUserAgent(UserAgent):
    ...
    valid_response_codes = frozenset(
        [200, 201, 202, 203, 204, 205, 206, 207, 208, 226, 301, 302, 303, 307]
    )
    ...
    def _urlopen(self, request):
        ...
        return self.response_type(
            resp, request=request, sent_request=resp._sent_request
        )
