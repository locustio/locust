...
class LocalRunner(Runner):
    ...
    def start(self, locust_count, hatch_rate, wait=False):
        ...
        if self.hatching_greenlet:
            ...
            self.hatching_greenlet.kill(block=True)
        self.hatching_greenlet = self.greenlet.spawn(lambda: super(LocalRunner, self).start(locust_count, hatch_rate, wait=wait))
...
class WorkerRunner(DistributedRunner):
    ...
    instructions to start and stop locust user greenlets. The WorkerRunner will preiodically
