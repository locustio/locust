...
def check_for_deprecated_wait_api(locust_or_taskset):
    ...
    if locust_or_taskset.wait_function:
        warnings.warn("Usage of wait_function is deprecated. Declare a %s.wait_time method instead "
    ...
    if locust_or_taskset.min_wait and locust_or_taskset.max_wait:
        ...
        warnings.warn("Usage of min_wait and max_wait is deprecated. Instead use: wait_time = between(%s, %s)" % (
