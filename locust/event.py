...
from . import log
from .exception import InterruptTaskSet, LocustStopTest, RescheduleTask, RescheduleTaskImmediately, StopUser
...
class EventHook:
    ...
    def fire(self, *, reverse=False, **kwargs):
        ...
        for handler in handlers:
            try:
                handler(**kwargs)
            except (StopUser, LocustStopTest, RescheduleTask, RescheduleTaskImmediately, InterruptTaskSet):
