...
- Warn if spawn rate is too high. Addresses bug \#1174 for example. [\#1211](https://github.com/locustio/locust/pull/1211) ([cyberw](https://github.com/cyberw))
...
- why drop the "-n" parameter after version 0.8 [\#1048](https://github.com/locustio/locust/issues/1048)
...
- Travis CI: The sudo tag is now deprecated in Travis CI [\#1037](https://github.com/locustio/locust/pull/1037) ([cclauss](https://github.com/cclauss))
...
- How to pass multiple request under same @task. Eg: If I need to pass different key for same get, how to do that? Is parameterization exist? [\#948](https://github.com/locustio/locust/issues/948)
...
- how to send post requests body type is raw [\#840](https://github.com/locustio/locust/issues/840)
...
- invalid Locust\(HttpLocust\) class attribute: host [\#773](https://github.com/locustio/locust/issues/773)
...
- Some of the requests total stats are missing when printing them to console [\#350](https://github.com/locustio/locust/issues/350)
...
- Issue with indentation on a PUT request \(Newbie\)  [\#641](https://github.com/locustio/locust/issues/641)
...
- Is there a way to share data among emulated users? [\#561](https://github.com/locustio/locust/issues/561)
...
- "Connection reset by peer"  failure When doing local test with lost \( \>1000\) concurrent users [\#545](https://github.com/locustio/locust/issues/545)
- How to monitor cpu and memory? [\#544](https://github.com/locustio/locust/issues/544)
- Stress test with protobuf format? [\#543](https://github.com/locustio/locust/issues/543)
...
- Get exception during simulating 5000 users on one machine [\#471](https://github.com/locustio/locust/issues/471)
...
- Unable to install locustio [\#336](https://github.com/locustio/locust/issues/336)
...
- How to send Ajax requests ? [\#219](https://github.com/locustio/locust/issues/219)
...
- RPS dropping to 0 at the end of the user ramp-up period [\#172](https://github.com/locustio/locust/issues/172)
